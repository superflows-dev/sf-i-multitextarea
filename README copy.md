...
[![NPM](https://img.shields.io/npm/v/sf-i-multitextarea.svg)](https://www.npmjs.com/package/sf-i-multitextarea) [![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com)
...
- **Header & Footer** - SfIMultitextarea component generates both the header and footer view
...
- **Search Input** - SfIMultitextarea ships with a search input field
- **Social Media** - SfIMultitextarea accepts social media links as an un-ordered list and renders them into the footer
- **Copyright Notice** - SfIMultitextarea accepts copyright notice as input and renders it into the footer
...
- **Call-to-action Button** - SfIMultitextarea comes with a call-to-action button, which can be used to highlight key actions such as sign in and subscribe.
...
- **Customizability** - SfIMultitextarea colors can be customized using css custom properties
- **Responsiveness** - SfIMultitextarea nicely adapts to all screen sizes
...
<html>
  <head>
    ...
    <title>&lt;sf-i-multitextarea&gt; Demo</title>
    <!-- Integration material icons as they are used in sf-i-multitextarea -->
    ...
    <!-- Integration lit and sf-i-multitextarea web components module -->
    <script type="module">
        import {LitElement, html, css} from 'https://unpkg.com/lit-element/lit-element.js?module';
        import {SfIMultitextarea} from 'https://unpkg.com/sf-i-multitextarea/sf-i-multitextarea.js?module';
    </script>
    <style>
      ...
      sf-i-multitextarea:not(:defined) {
        display: none;
      }
  ...
  <body style="margin: 0px;">
    ...
    <script>
      document.getElementsByTagName('sf-i-multitextarea')[0].addEventListener('searchClick', () => {console.log('hurray');})
      document.getElementsByTagName('sf-i-multitextarea')[0].addEventListener('routeChange', (e) => {
...
Routing is enabled by default. Every hash link specified in the SfIMultitextarea component needs to be backed by its separate html component. For example the links in the brand info section (above section), contains #home as the link. For routing to work, simply create a separate home.html component for it. SfIMultitextarea will then automatically take care of routing.
...
Search Input is shown by default and the SfIMultitextarea component throws a searchClick event after the user types something in the search input field and presses enter. To handle the searchClick event:

```html

    <script>
      document.getElementsByTagName('sf-i-multitextarea')[0].addEventListener('searchClick', () => {console.log('search clicked');})
    </script>
